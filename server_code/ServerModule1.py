...
def table_update(table_name,table):
  ...
  if table_name == "sys_siteuserrole": #special case for sys_siteuser table
    table_name_id = "Email" 
  else:
...
def table_insert(table_name,table):
  ...
  if table_name == "sys_siteuserrole":
...
def describe_table(table_name):
  if table_name in ["anvilusers","anviluser"]:
    ...
    query = ("SELECT COLUMN_NAME, COLUMN_TYPE, COLUMN_KEY, IS_NULLABLE, COLUMN_DEFAULT, COLUMN_COMMENT FROM INFORMATION_SCHEMA.COLUMNS WHERE "
